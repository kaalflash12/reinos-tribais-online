...
(()=>{
  ...
  loadScript('reino-tribal-branding.js?v=1.0.2','reino-tribal-branding','__REINO_TRIBAL_BRANDING__');
  ...
  loadScript('rt102-admin-recovery.js?v=1.0.2','rt102-admin-recovery','__REINO_TRIBAL_ADMIN_RECOVERY_V102__');
  ...
  // IDs RT antigos permanecem apenas por compatibilidade técnica. A versão pública atual é Reino Tribal v1.0.2.
})();