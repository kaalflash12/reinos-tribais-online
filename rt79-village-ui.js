...
(()=>{
  ...
  loadScript('reino-tribal-branding.js?v=1.0.3','reino-tribal-branding','__REINO_TRIBAL_BRANDING__');
  ...
  loadScript('rt85-auth-bridge.js?v=85.1','rt85-auth-bridge','__RT85_AUTH_BRIDGE__');
  loadScript('rt102-admin-recovery.js?v=1.0.3','rt102-admin-recovery','__REINO_TRIBAL_ADMIN_RECOVERY_V102__');
  ...
  // IDs RT antigos permanecem apenas por compatibilidade técnica. A versão pública atual é Reino Tribal v1.0.3.
})();
