...
assert a==b
required=['Reinos Tribais — RT76 Integrado','const VERSION = 76;','const RT_BUILD = "76.1";','const RT76_PLAN = true;','RT76_BRIDGE_START','window.__RT76_PLAN_APPLIED__=true','rt76-runtime.js?v=76.1','sem teletransporte']
