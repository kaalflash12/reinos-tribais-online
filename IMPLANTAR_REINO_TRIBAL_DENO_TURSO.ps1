...
Write-Host '=== REINO TRIBAL - BOOTSTRAP FINAL FIX4C ===' -ForegroundColor Cyan
Write-Host 'Deno device auth oficial; sem keychain, token manual ou TTY.' -ForegroundColor Green
...
$code=$LASTEXITCODE
if($code -ne 0){throw "Bootstrap FIX4C parou no proximo erro real. Codigo: $code"}
